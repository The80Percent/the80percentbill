"""The 20 bill articles. Format: (Title, Description, Link, Optional_Note, Skip_Numbering).
Skip_Numbering defaults to False if omitted."""
...
ARTICLES = [
    ...
    (
        ...
        "1. H.R. 4895: Expands negotiation to 50 drugs/year and applies lower prices to private insurance. 2. H.R. 853: Closes the 'Orphan Drug' loophole.",
    ...
    (
        "Fair Elections & End Gerrymandering",
    ...
    (
        "Ban Corporate Purchase of Single Family Homes",
    ...
    (
        "Ban 'Dark Money' (Overturn Citizens United)",
    ...
    (
        "Right to Repair (Ban 'Parts Pairing')",
    ...
    (
        ...
        "Note: No bill has currently been proposed in congress that would put the US on par with European data privacy standards established with the GDPR.  If a bill like this arises, we will opt for including that.",
    ),
    (
        "Veterans Care Choice",
        ...
        "Note: Improving veterans' access to healthcare was removed from our platform because the bill we were supporting (H.R. 8371) has already been successfully passed and signed into law.",
        True,  # Skip numbering - bill already passed
    ),
]